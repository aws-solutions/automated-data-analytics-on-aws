 ...
 * @required
 */
export const ID = 'SQLSERVER' as const;

/**
 * Interface for the "sourceDetails" of data products of this connector
 * @required
 */
export interface ISourceDetails__SQLSERVER extends ISourceDetails__JDBC {}

/**
 * Interface for the "sourceDetails" wizard form data of data products of this connector
 * @required
 */
export type IFormData__SQLSERVER = Connectors.IFormData<{
 ...
 * @required
 */
export const CONNECTOR: Connectors.IConnector<ISourceDetails__SQLSERVER, IFormData__SQLSERVER> = {
  ID,
  FOLDER: 'jdbc_sqlserver',

  // Interface references - used for typecasting only
  ISourceDetails: {} as ISourceDetails__SQLSERVER,
  ISourceDetailsFormData: {} as IFormData__SQLSERVER,

  METADATA: {
    label: 'Microsoft SQL Server',
    description: 'Data product from Microsoft SQL Server database',
      ...
      fields: [
        {
          ...
          description:
            'Enter the database endpoint or host name for SQL Server database. Ensure the network connectivity has been correctly set up.',
          placeholder: '',
          ...
          validate: [
            ...
            },
            {
              ...
              message: 'Must be a valid database endpoint, host name or ip address',
            },
          ],
        },
        {
          ...
          label: 'Database Port',
          description: 'Enter the database port for SQL Server database',
          placeholder: '1433',
          helperText: '',
          helperTextAsAlert: 'info',
          validate: [
