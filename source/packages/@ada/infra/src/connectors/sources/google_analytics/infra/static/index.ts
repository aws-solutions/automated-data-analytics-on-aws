  ...
  staticInfra: (constructor) => {
    return class StaticInfrastructureStack extends constructor implements Connectors.Infra.StaticStackFor<typeof ID> {
      ...
      constructor(scope: Construct, id: string, props: StaticInfra.Stack.IConstructProps) {
        ...
        // STATIC INFRA
        ////////////////////////////////////////////
        this.googleAnalyticsECSCluster = this.ingressContainerInfra.createCluster('GoogleAnalytics', {
          // NOTE: consider resizing
          cpu: 2048, // 2GB
          memoryMiB: 16384, // 16GB
          name: 'google-analytics',
          imageTarballPath: getDockerImagePath(Connectors.getDockerImageName('GOOGLE_ANALYTICS')),
        });

        this.googleAnalyticsImportDataStateMachine = new ImportDataStateMachine(this, 'GAImportDataStateMachine', {
          cluster: this.googleAnalyticsECSCluster.cluster,
          taskDefinition: this.googleAnalyticsECSCluster.taskDefinition,
          containerDefinition: this.googleAnalyticsECSCluster.containerDefinition,
        ...
        ////////////////////////////////////////////
        this.staticInfraParameterValue.googleAnalyticsConnector = {
  ...
  staticInfraRefs: (constructor) => {
    return class StaticInfrastructureReferences extends constructor implements Connectors.Infra.IRefsFor<typeof ID> {
      ...
      constructor(scope: Construct, id: string, props: StaticInfra.Refs.IConstructProps) {
        ...
        ////////////////////////////////////////////
        this.staticInfrastructureReferences.googleAnalyticsConnector = {
          importDataStateMachine: StateMachine.fromStateMachineArn(
            this,
            'GoogleAnalyticsImportDataStateMachine',
            props.staticInfrastructure.googleAnalyticsConnector.importDataStateMachineArn,
          ),
        };
      }
    };
