...
import { PATTERN_DB_PORT, PATTERN_NOT_EMPTY, PATTERN_ORACLE_USERNAME, TEXT_FIELD } from './constants';
 ...
 * @required
 */
export interface ISourceDetails__ORACLE extends ISourceDetails__JDBC {}

/**
 * Interface for the "sourceDetails" wizard form data of data products of this connector
 * @required
 */
export type IFormData__ORACLE = Connectors.IFormData<{
 ...
 * @required
 */
export const CONNECTOR: Connectors.IConnector<ISourceDetails__ORACLE, IFormData__ORACLE> = {
  ID,
  FOLDER: 'jdbc_oracle',

  // Interface references - used for typecasting only
  ISourceDetails: {} as ISourceDetails__ORACLE,
  ISourceDetailsFormData: {} as IFormData__ORACLE,

  METADATA: {
    label: 'Oracle',
    description: 'Data product from Oracle database',
      ...
      fields: [
        {
          ...
          description:
            'Enter the database endpoint or host name for the Oracle database. Ensure the network connectivity has been correctly set up.',
          placeholder: '',
        ...
        },
        {
          ...
          label: 'Database Port',
          description: 'Enter the database port for the Oracle database',
          placeholder: '1521',
          helperText: '',
          helperTextAsAlert: 'info',
          validate: [
        ...
        },
        {
          ...
          validate: [
            ...
            {
              type: 'pattern',
              pattern: PATTERN_ORACLE_USERNAME,
              message:
