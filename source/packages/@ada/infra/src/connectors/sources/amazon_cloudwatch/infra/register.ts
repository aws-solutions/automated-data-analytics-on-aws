...
declare module '@ada/connectors/interface' {
  interface CONNECTOR_INFRA_REGISTRY {
    [ID]: Connectors.IConnectorInfra<
      // Static Parameters
      {
        cloudWatchConnector: Connectors.Infra.Static.ImportData.StateMachine.Param;
      },
      // Static Refs
      {
        cloudWatchConnector: Connectors.Infra.Static.ImportData.StateMachine.Ref;
      },
      // Static Stack Properties
      {
        readonly amazonCloudWatchECSCluster: DataIngressECSCluster;
