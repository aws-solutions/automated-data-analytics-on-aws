...
declare module '@ada/connectors/interface' {
  interface CONNECTOR_INFRA_REGISTRY {
    [ID]: Connectors.IConnectorInfra<
      // Static Parameters
      {
        cloudTrailConnector: Connectors.Infra.Static.ImportData.StateMachine.Param;
      },
      // Static Refs
      {
        cloudTrailConnector: Connectors.Infra.Static.ImportData.StateMachine.Ref;
      },
      // Static Stack Properties
      {
        readonly amazonCloudTrailECSCluster: DataIngressECSCluster;
