...
import * as stories from './oracle.stories';
...
describe(`CreateDataProductView/${Connectors.ORACLE.ID}`, () => {
  describe('storybook', () => {
    it(`working - ${Connectors.ORACLE.ID}`, async () => {
    ...
    it(`input error - ${Connectors.ORACLE.ID}`, async () => {
